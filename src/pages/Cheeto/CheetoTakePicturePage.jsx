...
function CheetoTakePicturePage({ studentID, selectedFrameSrc }) {
  ...
  return (
    <div className="flex w-screen h-screen">
      ...
      <div
        className="flex fixed right-[32px] top-[22px] w-[304px] h-[907px]"
        id="capture-div"
      >
        ...
        <div className="z-10 fixed top-[-20px] right-[10px]">
          <img
...
export default CheetoTakePicturePage;
