...
function LandingPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen gap-6">
      ...
      <div className="flex w-1/2 gap-8 h-3/4">
        <div
        ...
        >
          <img
            ...
            className="h-5/6"
          ></img>
          <button className="w-full h-1/6 btn btn-dark btn-lg">
            두잇 기본 프레임
          </button>
        </div>
        <div
        ...
        >
          <img
            ...
            alt="검정_두잇.png"
          ></img>
          <button className="w-full h-1/6 btn btn-secondary btn-lg">
            두잇 글자 프레임
          </button>
        </div>
        <div
        ...
        >
          <img
            ...
            className="h-5/6"
          ></img>
          <button className="w-full h-1/6 btn btn-primary btn-lg">
            치토 프레임
          </button>
        </div>
      </div>
